...
-(void)login:(UIViewController*)viewController{
    //441432
    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"%@?response_type=code&client_id=%@&scope=%@&state=441432&redirect_uri=%@&expires_in=%@&prompt=login",authUrl,clientID,defaultScope,redirectURI,expiresIn]];
